...
");
  ...
  <script src='app.js'></script>
    ...
    private function topmenu() {
        ...
        if (Authentication::isAuthenticated()) {
            $s .= sprintf("%8s<div id='user-welcome'><h1>Welcome to Yadda, $%s</h1><div id='img-container'><img src='model/UserImage.php?uid=%s' width='240' height='auto'</div></div>\n", " ", Authentication::getLoginId(), Authentication::getLoginId());
         }
        return $s;
    }
