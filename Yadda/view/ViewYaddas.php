...
class YaddaView extends View {
    ...
    private function displayManyYaddas() {
        ...
        foreach ($yaddas as $yadda) {
            ...
            <div id='d-yadda'>
            <b id='yadda-username'>
            <img src='model/UserImage.php?uid=%8s' width='50' height='auto'</div>\n
            @%s
            </b>
            <p>
            %s:
            ...
            <input type='submit' value='Reply' id='yadda-reply'/>
                ...
                , "%s", $yadda->getUid(), $yadda->getTstamp(), $yadda->getContent());
        }
        return $s;
    }
    ...
    private function yaddaForm() {
        $s = sprintf("<h1>Yaddas Timeline</h1>\n
                    ...
                    //     $s .= sprintf("<img src='model/UserImage.php?uid=%s' width='50' height='auto'</div>\n", Authentication::getLoginId());
                    //  }
